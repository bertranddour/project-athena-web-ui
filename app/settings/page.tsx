    ...
    <div className="min-h-dvh bg-zinc-200 px-6 py-8">
      <div className="mx-auto flex max-w-4xl flex-col space-y-16">
        ...
        <div className="space-y-6">
          <section className="rounded-[1.8rem] bg-zinc-200 p-8 shadow-wave-panel">
            {user === undefined ? (
          ...
          <section className="rounded-[1.8rem] border border-zinc-300/60 bg-zinc-200 p-6">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div className="space-y-1">
                <p className="text-xs uppercase tracking-[0.3em] text-zinc-500">Tool execution</p>
                <p className="text-sm text-zinc-600">
                  Choose whether tool call outputs appear inline next to assistant responses.
                </p>
              </div>
              <Switch
